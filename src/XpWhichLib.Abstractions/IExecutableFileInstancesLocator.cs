...
public interface IExecutableFileInstancesLocator
{
    ...
    FileInfo[] LocateExecutableInstances(string executableName);
    ...
    FileInfo[] LocateExecutableInstancesWithinDrive(DriveInfo driveInfo,
    ...
    FileInfo[] LocateExecutableInstancesWithinDirectory(DirectoryInfo directory,
        string executableName);
}